...
public class News {
    ...
    UIBuilder.registerCustomComponent("imageViewer", ImageViewer.class);
       ...
       NewsForm = new Form("News", BoxLayout.y());
       NewsForm.setUIID("BtnPostAction");
    UIBuilder.registerCustomComponent("imageViewer", ImageViewer.class);
...
Container MenuForm = new Container( new GridLayout(1,4));
    ...
    Form NewsForm = NewsF.News();
     ...
     MesArticle.addActionListener((evt) -> {
       MesArticle MesArticleF = new MesArticle();
              Form MesArticleForm = MesArticleF.MesArticle(new Article(1));
              MesArticleForm.show();
    });
    ...
    try {
                ...
                Image iconNews = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/newsS.png");
    ...
    try {
                ...
                Image iconRecom = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/recom.png");
   ...
   NewsForm.add(MenuForm);
   
   for(Article ListArt : SA.NewsJ())
       {
           addItem(ListArt);
    ...
    /*Toolbar tb = NewsForm.getToolbar();
...
//            NewsForm.show();
        ...
        NewsForm.getToolbar().addCommandToOverflowMenu("Ajout Article",FontImage.createMaterial(FontImage.MATERIAL_POST_ADD, NewsForm.getUnselectedStyle(), CENTER), (ActionListener) (ActionEvent evt) -> {
            
            InterfaceAjoutArticle aj = new InterfaceAjoutArticle();
            Form ajoutArticle = aj.InterfaceAjoutArticle();
            ajoutArticle.showBack();
        });*/
        ToolbarInitializer.initToolbar(NewsForm);
  ...
  try {
    ...
    System.out.println("hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh");
       ...
       NewsForm.add(BoxArticleContainer);
     }
