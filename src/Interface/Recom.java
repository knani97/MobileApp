...
public class Recom {
    ...
    UIBuilder.registerCustomComponent("imageViewer", ImageViewer.class);
       ...
       ArticleRecForm = new Form("Article Recommandée", BoxLayout.y());
       ArticleRecForm.setUIID("BtnPostAction");
    UIBuilder.registerCustomComponent("imageViewer", ImageViewer.class);
  ...
  Container MenuForm = new Container( new GridLayout(1,4));
   ...
   MenuForm.add(News);
    ...
    try {
                ...
                Image iconNews = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/news.png");
    ...
    try {
                ...
                Image iconMesArticle = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/mesArticle.png");
    ...
    try {
                ...
                Image iconRecom = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/recomS.png");
    ...
    try {
                ...
                Image iconArticleP = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/articleP.png");
   ...
   ArticleRecForm.add(MenuForm);
   
   for(Article ListArt : SA.RecomA())
       {
           addItem(ListArt);
    ...
    /*Toolbar tb = ArticleRecForm.getToolbar();
    ...
    Image icon =theme.getImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/logodocpdf.png");
        ...
        ArticleRecForm.getToolbar().addCommandToOverflowMenu("Ajout Article",FontImage.createMaterial(FontImage.MATERIAL_POST_ADD, ArticleRecForm.getUnselectedStyle(), CENTER), (ActionListener) (ActionEvent evt) -> {
            
            InterfaceAjoutArticle aj = new InterfaceAjoutArticle();
            Form ajoutArticle = aj.InterfaceAjoutArticle();
            ajoutArticle.showBack();
        });*/
        ToolbarInitializer.initToolbar(ArticleRecForm);
      
        
        
        ArticleRecForm.show();
        return ArticleRecForm;
    }
  ...
  try {
    ...
    DisLikeBtn.setUIID("BtnPostAction");
     ...
     if(SA.ReagitLike(new Reagit(ListArt.getId())).size()==0)
     {
         try {
                ...
                Image imgLike = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/like.png");
         ...
         LikeBtn.addActionListener((ActionListener) (ActionEvent evt) -> {
          try {
                ...
                Image imgLike = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/likeS.png");
                LikeBtn.setIcon(imgLike.scaledLargerRatio(95,95));
                ...
                Image imgDisLike = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/dislike.png");
         ...
         if(SA.ReagitDisLikeJ(new Reagit(ListArt.getId())).size()==0)
     {
         try {
                ...
                Image imgLike = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/dislike.png");
         ...
         DisLikeBtn.addActionListener((ActionListener) (ActionEvent evt) -> {
          try {
                ...
                Image imgLike = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/dislikeS.png");
                DisLikeBtn.setIcon(imgLike.scaledLargerRatio(95,95));
                ...
                Image imgDisLike = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/like.png");
         ...
         if(SA.ReagitLike(new Reagit(ListArt.getId())).size()>0)
         {
             try {
                 ...
                 Image imgLikeIcon = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/likeS.png");
             ...
             try {
                 ...
                 Image imgLikeIcon = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/like.png");
                 LikeBtn.setIcon(imgLikeIcon.scaledLargerRatio(95,95));
             } catch (IOException ex) {
          ...
          if(SA.ReagitDisLikeJ(new Reagit(ListArt.getId())).size()>0)
         {
             try {
                 ...
                 Image imgDisLikeIcon = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/DislikeS.png");
             ...
             try {
                 ...
                 Image imgLikeIcon = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/dislike.png");
    ...
    System.out.println("hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh");
       ...
       ArticleRecForm.add(BoxArticleContainer);
     }
