...
public class MesArticle {
    ...
    try {
                ...
                Image iconMesArticle = Image.createImage("file:///C:/Users/mouhe/OneDrive/Documents/NetBeansProjects/DOCTOURNA-mobile/src/Images/mesArticleS.png");
   ...
   for(Article ListArt : SA.MesArticles())
    ...
    try {
                ...
                System.out.println(ListArt.users.getImage());
