 ...
 * @author mouhe
 */
public class EditCalendrierForm {
    public Form mainForm = new Form();
    public Form current = new Form("Modif Calendrier", BoxLayout.y());
    public Calendrier calendrierOrig = new Calendrier();
    ...
    public EditCalendrierForm() {
        this.calendrierOrig = cs.getCalendrierByUid(Session.getId());
    }
    ...
    public void init() {
        ...
        txtTimezone.setText(calendrierOrig.getTimezone());
        ...
        chcBoxEmail.setSelected(calendrierOrig.getEmail());
        ...
        btnAjout.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                calendrier.setId(cs.getCalendrierByUid(Session.getId()).getId());
    ...
    public void initPicker() {
        ...
        MultiButton b = new MultiButton(calendrierOrig.getFormat() == 1 ? "Plage Horaire" : "Calendrier Standard");
        ...
        format = calendrierOrig.getFormat();
        current.add(b);
    }
}
