...
public class RechercheService {
    ...
    public RechercheService() {
        ...
        String url = Statics.BASE_URL + "/inventaire/search/" + med.getNomMed();
        request.setUrl(url);
        ...
        try {
            ...
            for (Map<String, Object> obj : list) {
                ...
                String gouvernourat = obj.get("gouvernourat").toString();
                
                String img_patente = obj.get("img_patente").toString();
